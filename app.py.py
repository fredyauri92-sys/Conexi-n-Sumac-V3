    ...
    for i in range(0, len(PRODUCTOS_INFO), 2):
        ...
        with col1:
            ...
            with sub_left:
                ...
                st.markdown(f"<div style='text-align: center; font-weight: bold; font-size: 12px; line-height: 1.1; margin-top: -2px; width: 100%;'>{p1.get('icono', '🍲')} {p1['nombre']}</div>", unsafe_allow_html=True)
                st.markdown(f"<p style='text-align: center; color: #FFEA00; font-weight: bold; font-size: 11px; margin: 0; padding-bottom: 2px; width: 100%;'>S/. {p1['precio']:.2f} <span style='color: #888888; font-weight: normal; margin-left: 3px;'>• Hoy: {cant1}</span></p>", unsafe_allow_html=True)
        ...
        if i + 1 < len(PRODUCTOS_INFO):
            ...
            with col2:
                ...
                with sub_left2:
                    ...
                    # Descripción centrada súper compacta en la misma recta del botón
                    st.markdown(f"<div style='text-align: center; font-weight: bold; font-size: 12px; line-height: 1.1; margin-top: -2px; width: 100%;'>{icono_p2} {p2['nombre']}</div>", unsafe_allow_html=True)
                    st.markdown(f"<p style='text-align: center; color: #FFEA00; font-weight: bold; font-size: 11px; margin: 0; padding-bottom: 2px; width: 100%;'>S/. {p2['precio']:.2f} <span style='color: #888888; font-weight: normal; margin-left: 5px;'>• Hoy: {cant2}</span></p>", unsafe_allow_html=True)
