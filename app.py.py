    ...
    for i in range(0, len(PRODUCTOS_INFO), 2):
        ...
        with col1:
            ...
            with sub_left:
                ...
                st.markdown(f"<div style='text-align: center; font-weight: bold; font-size: 12px; line-height: 1.1; margin-top: -2px;'>{p1.get('icono', '🍲')} {p1['nombre']}</div>", unsafe_allow_html=True)
